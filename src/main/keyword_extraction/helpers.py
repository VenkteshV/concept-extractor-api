...
def init_keyword_extractor(config):
    ...
    if rank_config.get('class') in ['CoTagRank','TopicCSRankLDA','CoTagRankSentenceUSE','CoTagRankPositional','TopicCSRank', 'CoTagRankWindow','CoTagRanks2v' , 'EmbedRank' , 'EmbedRankSentenceUSE']:
